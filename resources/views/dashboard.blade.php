...
<!-- Mirrored from dompet.dexignlab.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Apr 2024 14:59:24 GMT -->
							...
							<div class="card coin-card">
								<div class="card-body d-sm-flex d-block align-items-center">
									<span class="coin-icon">
										<i class="fa-regular fa-copy" style="height: 25px;width: 25px;"></i>
									</span>
									<div>
										<h3 class="text-white">Your Referral Link</h3>
										<p>https://www.referral-Link.com/Referral-ID</p>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="footer">
			...
			<div class="copyright">
				<p>Copyright © Designed &amp; Developed by <a href="https://raheelanwaar.com/"
						target="_blank">Shopify</a> 2024</p>
			</div>
		</div>
		<!--**********************************
            Footer end
