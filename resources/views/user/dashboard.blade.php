                ...
                <div class="col-xl-6 col-xxl-6 col-sm-6">
                    <div class="card bg-warning invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">${{ number_format(auth()->user()->balance,5) }} | {{ $withdrawAble }} Pkr
                                </h2>
                ...
                {{-- <div class="col-xl-4 col-xxl-3 col-sm-6">
                    <div class="card bg-success invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">{{ auth()->user()->level }}</h2>
                                <span class="text-white fs-18">Level</span>
                            </div>
                        </div>
                    </div>
                </div> --}}
